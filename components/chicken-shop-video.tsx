...
interface ChickenShopVideoProps {
  src: string
  title: string
}

export default function ChickenShopVideo({ src, title }: ChickenShopVideoProps) {
  ...
  return (
    <div
      className="relative w-full aspect-video bg-[#0a0a0a] rounded-2xl overflow-hidden shadow-lg group"
